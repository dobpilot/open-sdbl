...
типу ссылки `ССЫЛКА`, несколько источников через запятую, итоги `ИТОГИ … ПО`
...
`УПОРЯДОЧИТЬ ПО` и `В ИЕРАРХИИ`, `МЕЖДУ`, `ТИП`/`ТИПЗНАЧЕНИЯ`, `НЕОПРЕДЕЛЕНО`,
группирующие наборы, строковые и математические функции, виртуальные таблицы
регистров бухгалтерии и расчёта,
